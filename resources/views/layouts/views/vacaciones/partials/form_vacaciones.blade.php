        ...
        <div class="box-body">
            ...
            <div class="row" style="padding: 10px 0;">
                <div class="col-xs-4">
                    <div class="input-group" data-toggle="tooltip" title="Inicio de vacaciones">
                        ...
                        <input type="date" name="fecha_inicio" id="fecha_inicio" onchange="verificar_fechas()"
                ...
                <div class="col-xs-4">
                    <div class="input-group" data-toggle="tooltip" title="Fin de vacaciones">
                        ...
                        <input type="date" name="fecha_fin" id="fecha_fin" onchange="verificar_fechas()"
                ...
                <div class="col-xs-4">
                    <div class="input-group" data-toggle="tooltip" title="Cantidad de días">
                            <span class="input-group-addon" style="background: #D9D9D9;cursor: pointer">
                                <i class="fa fa-adjust" aria-hidden="true"></i> Días
                            </span>
            ...
            <div style="padding-top: 10px">
                ...
                <div class="col-md-1 text-right" style="padding: 0;">
                    ...
                    <button type="button" class="btn btn-info pull-right" id="btn_store_vacaciones" onclick="store_vacaciones()">
